...
# We use regex to find the input block for discount_price, regardless of the Arabic text.
pattern = r'(<div className="flex items-center gap-2">\s*<span>[^<]*</span>\s*<input\s*type="number"\s*value=\{sp\.discount_price\}.*?className="w-20 p-1 border rounded text-center dark:bg-gray-600"\s*/>\s*</div>)'
