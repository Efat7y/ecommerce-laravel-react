...
class SmartCalculatorController extends Controller
{
    ...
    public function destroyRecipe(Request $request, $id) { if ($request->user()->role !== 'admin') return response()->json(['message' => 'Unauthorized'], 403); CalcRecipe::findOrFail($id)->delete(); return response()->json(['message' => 'Deleted']); }
